class Definer {
  ...
  // gym auth related errors

  static mongo_val_error = "att: mongodb validation failed";
  static auth_err3 = "att: no user with that  user_nick";
  static auth_err4 = "att: your credentials do not match user_password";
  ...
  // gym related errors
  static user_err1 = "att: file upload is failed";
  ...
  static article_err1 = "att: author user for article is not provided";
  static article_err2 = "att: no articles found for that user ! ";
